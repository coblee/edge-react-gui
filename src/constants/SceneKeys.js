...
export const PLUGIN_LIST_BUY = 'pluginListBuy'
export const PLUGIN_LIST_SELL = 'pluginListSell'
export const PLUGIN_VIEW_BUY = 'pluginViewBuy'
export const PLUGIN_VIEW_SELL = 'pluginViewSell'
